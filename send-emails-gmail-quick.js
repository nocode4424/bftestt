...
async function sendEmailsViaGmail() {
    try {
        ...
        // Create Gmail transporter - EASY SETUP!
        const transporter = nodemailer.createTransporter({
            service: 'gmail',
            auth: {
                user: 'jeffagordon@gmail.com', // Your Gmail
        ...
        console.log('🚀 Starting Gmail Email Campaign...');
        ...
        for (let i = 0; i < uniqueCustomers.length; i++) {
            ...
            try {
                const mailOptions = {
                    from: 'Bluefin Sushi <jeffagordon@gmail.com>',
        ...
        fs.writeFileSync('gmail-campaign-results.json', JSON.stringify(results, null, 2));
        console.log(`📄 Results saved to gmail-campaign-results.json`);
...
console.log(`
🚀 Gmail Email Campaign - EASY SETUP!

To send all 40 emails right now:
...
3. Replace 'your-app-password-here' in this script with your generated password
4. Run: node send-emails-gmail-quick.js

That's it! Gmail will send all 40 emails with the Labor Day promotion.

⚠️  Note: Gmail has daily sending limits (500 for regular accounts)
`);

// Uncomment the line below after setting up your Gmail app password
// sendEmailsViaGmail();
