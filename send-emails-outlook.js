...
async function sendEmailsViaOutlook() {
    try {
        ...
        // Create email transporter for jg@askaero.com
        ...
        console.log('🚀 Starting Outlook Email Campaign...');
        console.log('📧 Sending emails with 2-second delays to avoid rate limits...');
        ...
        for (let i = 0; i < uniqueCustomers.length; i++) {
            ...
            try {
                const mailOptions = {
                    from: 'Bluefin Sushi <jg@askaero.com>',
        ...
        fs.writeFileSync('outlook-campaign-results.json', JSON.stringify(results, null, 2));
        console.log(`📄 Results saved to outlook-campaign-results.json`);
...
console.log(`
🚀 Outlook Email Campaign - EASY SETUP!

To send all 40 emails through Outlook:

1. Replace 'your-outlook-email@outlook.com' with your actual Outlook email
2. Replace 'your-outlook-password' with your Outlook password
3. Run: node send-emails-outlook.js

That's it! Outlook will send all 40 emails with the Labor Day promotion.

⚠️  Note: Make sure to use your actual Outlook email and password
`);

// Sending emails now!
sendEmailsViaOutlook();
